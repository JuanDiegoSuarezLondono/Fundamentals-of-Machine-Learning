...
## Overview
This assignment aims to reinforce your understanding of correlation. A scatterplot of two random variables is shown in an image, and you are asked to guess the correlation between these variables.
...
### How do I open the activity?
 To view the activity, click on the file `coding_activity_2.7.ipynb` in the panel on the left. 
