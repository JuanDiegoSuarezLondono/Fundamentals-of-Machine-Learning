# Codio Activity 2.2: Measures of Central Tendency and Gaussian Distributions
...
2. Create and interpret probability density functions, histograms, scatter plots, pair plots, and correlation matrices
...
Create a Gaussian distribution of ten numbers, then calculate the mean and the variance
...
### How do I open the activity?
 To view the activity, click on the file `Coding_Activity_2.2.ipynb` in the panel on the left. 
